...
<div class="dashboard" style="background-color:#fff;">
	...
	<div class="dashboard" style="background-color:#fff;">
		<h3 class="text-center" style="background-color:#272327;color: #fff;padding: 5px;">Doctor Registration</h3>
	...
	<!-- this is for donor registraton -->
		...
		<form enctype="multipart/form-data" action=""  method="post" class="text-center" style="margin-left: 110px">
			 <div class="col-md-12">
					...
					<label>Expertise
										<input type="text" name="expertise" value="" placeholder="expertise" >
